        ...
        <div class="main-panel">
            ...
            <div class="content">
                    ...
                    <div class="col-md-8">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="title">Other Complaints</h5>
                            </div>
                            <div class="card-body">
                               <form method="post" action="../process/otcomplain.php">
                ...
                ?>	   
                                       ...
                                       <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Query</label>
                                                <textarea rows="4" cols="80" class="form-control" placeholder="Max 1000 Letters" value=""></textarea>
                                            </div>
                                        </div>
                                    </div>
                      ...
                      <option value="3">D.V.C</option>
                      <option value="4">V.C</option>
                  </select>
                                            </div>
                                        </div>
                                    </div>
